...
public class TelegramBotUpdatesListener implements UpdatesListener {
    ...
    private void sendWelcomeMessage(long chatId) {
        SendMessage message = new SendMessage(chatId, "Привет! Я твой бот-напоминалка. Отправьте мне сообщение в формате: День.Месяц.Год Часы:Минуты Текст напоминания");
...
//    private Logger logger = LoggerFactory.getLogger(TelegramBotUpdatesListener.class);dd.MM.yyyy HH:mm
//
//    @Autowired
